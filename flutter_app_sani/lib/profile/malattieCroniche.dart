...
class MalattieCroniche extends StatelessWidget {
  @override
              ...
              children: <Widget>[
                ...
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        Expanded(child: Image.asset("assets/malattie.png"))
                      ],
                    ),
                  ],
                )
  ...
  Container infoProfile(BuildContext context) {
    return Container(
        ...
        child: Column(
          children: [
            rowProfile(context, "     lupus eritematoso sistemico"),
            SizedBox(height: 16.0),
            rowProfile(context, "     pancreatite cronica"),
            SizedBox(height: 16.0),
            rowProfile(context, "     polmonite eosinofila cronica"),
            SizedBox(height: 16.0),
            rowProfile(context, "     asma"),
            SizedBox(height: 16.0),
            rowProfile(context, "    celiachia"),
            SizedBox(height: 16.0),
          ],
        ));
  }
